...
- **Improved VM State Classification**: Refactored `vde list` to use real-time Docker data; replaced misleading `[ORPHANED]` marker with `[CREATED]` for VMs with config but no container.
