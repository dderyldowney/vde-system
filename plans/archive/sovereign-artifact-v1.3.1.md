...
- `RELEASE_NOTES.md`
- `docs/releases/1.3.1.md` (New archive record)

## Proposed Solution
We will systematically update the core four artifacts to reflect the new state of the VDE pipeline:
1.  **VDE-SPEC.md**: Bump version to 1.3.1 and note the hardened CI/CD ZSH purity requirements.
...
4.  **RELEASE_NOTES.md**: Add the 1.3.1 entry summarizing the CI/CD hardening and linking to the new archive record.
5.  **docs/releases/1.3.1.md**: Create the formal record of the release, detailing the empirical test pass counts and the elimination of legacy agent debt.
...
1. Confirm all four files of the Sovereign Artifact set mention version 1.3.1.
