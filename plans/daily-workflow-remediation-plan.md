# Daily Workflow Remediation Plan
...
- **Steps**:
  1. Execute `./run-tests.zsh --docker-free`
...
- **Exit Criteria**: docker-operations baseline maintained
...
- **Steps**:
  1. Run `behave tests/features/ --dry-run` to list undefined steps
