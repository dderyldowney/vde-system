# ROS-specific base image that renames ubuntu user to devuser
# This is needed because ros:rolling-perception already has ubuntu:1000:1000
ARG BASE_IMAGE=ros:rolling-perception
FROM ${BASE_IMAGE}
