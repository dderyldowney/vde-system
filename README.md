...
| **Ancient Intel** | [API Reference](docs/API.md) • [Architecture 1.5.0](docs/ARCHITECTURE.md) • [Release Archive](https://github.com/dderyldowney/vde-system/tree/stable/docs/releases) |
...
| [Architecture 1.5.0](docs/ARCHITECTURE.md) | Technical blueprint of the Hub |
