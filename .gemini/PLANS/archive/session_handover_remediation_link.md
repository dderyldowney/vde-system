...
- Remediation plan location: `.gemini/PLANS/session_handover_remediation.md`.
...
- Use session_handover_remediation.md for actionable steps, milestones, and verification criteria.
- Maintain synchronization: update both documents when changes occur; ensure the remediation plan reflects the current handover context.
