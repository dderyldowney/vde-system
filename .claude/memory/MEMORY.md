...
- [Swarm+MCP mandatory for multi-step batches](feedback_swarm_mcp_mandate.md) — >3 step fix batches must use parallel sub-agent swarm + sequential-thinking MCP; main agent synthesizes only
...
- [Refresh language docs via context7 at session start](feedback_context7_language_refresh.md) — fetch behave, Python, PyYAML, json docs in parallel on every resume
